...
│
├── training_code/
│   ├── final_miniature_model_training/
│   │   ├── README.md
│   │   ├── data.yaml
│   │   └── train_miniature_yolov8.py
│   │
│   └── real_world_model_training/
│       ├── README.md
│       ├── data.yaml
│       └── train_real_world_yolov8.py
│
├── models/
│   └── README.md
│
...
│
├── gifs/
│   ├── display_crosswalk_jaywalking.gif
│   ├── display_emergency_vehicle_yielding.gif
│   ├── display_fall_detection.gif
│   ├── display_illegal_parking.gif
│   ├── display_illegal_uturn.gif
│   ├── display_road_jaywalking.gif
│   ├── display_vehicle_crosswalk_violation.gif
│   ├── real_crosswalk_jaywalking.gif
│   ├── real_emergency_vehicle_yielding.gif
│   ├── real_fall_detection.gif
│   ├── real_illegal_parking.gif
│   ├── real_illegal_uturn.gif
│   ├── real_road_jaywalking.gif
│   └── real_vehicle_crosswalk_violation.gif
│
└── videos/
│   ├── display_crosswalk_jaywalking.mp4
│   ├── display_emergency_vehicle_yielding.mp4
│   ├── display_fall_detection.mp4
│   ├── display_illegal_parking.mp4
│   ├── display_illegal_uturn.mp4
│   ├── display_road_jaywalking.mp4
│   ├── display_vehicle_crosswalk_violation.mp4
│   ├── real_crosswalk_jaywalking.mp4
│   ├── real_emergency_vehicle_yielding.mp4
│   ├── real_fall_detection.mp4
│   ├── real_illegal_parking.mp4
...
| 폴더 | 설명 |
|---|---|
| `docs/` | 대회 제출용 프로젝트 보고서 PDF 저장 |
| `code/` | Raspberry Pi 최종 제어 코드, Arduino 코드, DB 확인 코드 저장 |
| `training_code/` | YOLO 모델 학습에 사용한 코드 및 `data.yaml` 저장 |
| `models/` | 모델 파일 다운로드 안내 및 사용 방법 정리 |
| `imgs/` | README에 사용되는 시스템 구성도, 학습 결과, LED 결과 이미지 저장 |
| `gifs/` | README에 삽입되는 이벤트별 실물/디스플레이 GIF 저장 |
| `videos/` | 최종 시연 영상 원본 또는 원본 영상 링크 관리 |
